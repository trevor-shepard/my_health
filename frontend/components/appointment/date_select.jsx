            ...
            <div>
                <div>
                    ...
                    <div className='margin-twenty-one'>
                        ...
                        <div>
                            <div className='second-header'>Preferred Dates:</div>
                            { this.state.error}
                            <div>
                                <input className='date-select' type="date" onChange={this.handleInput('start')}/>
                                To: 
                                <input className='date-select' type="date"  onChange={this.handleInput('end')}/>
